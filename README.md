# PHP Blog
Creating a blog using _PHP_. For this blog, I will be creating different CRUDs needed for the functionality of the blog itself.
...
1. We'll need `XAMPP` for creating the system; any web server may be usable.
    1. `XAMPP` installs PHP and other settings needed for the system to work.
2. The tutorial itself explains that for the DB, we'll be using **SQLite**.
    1. If `XAMPP` is being used, `MySQL` can be used. The connection for this db isn't taught, though.
3. Any code editor. I use Visual Studio Code (personal preference).
